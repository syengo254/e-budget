...
<title>SERVICES ON: E-budget.com</title>
</head>
<body>
<div id="cont">
	<div id="header">
    ...
    <div id="content">
        ...
        <div id="content-body">
        	<div class="d_box">
            	<div class="btitle">
                	<span style="position:relative; top:7px;">Our services:</span>
                </div>
                <div class="d_body">
                Our services are as follows:
                    <ul>
                    	<li>Store products display</li>
                        <li>Online shopping services</li>
                        <li>Product Adverts</li>
                        <li>Door delivery</li>
                    </ul>
                Thanks, we hope you will enjoy our services.
                </div>
            </div>
        </div>
    </div><!--end content div-->
