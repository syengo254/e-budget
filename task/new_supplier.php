...
<link rel="stylesheet" type="text/css" href="../styles/newsupp.css"/>
<link REL="SHORTCUT ICON" HREF="../images/site_icon.png">
<script type="text/javascript" src="../scripts/jQuery.js"></script>
<script type="text/javascript" src="../scripts/supp.js"></script>
<title><?php echo 'E-budget.com::step '.$_GET["step"]; ?></title>
</head>
<body>
<div id="cont">
	<div id="header">
